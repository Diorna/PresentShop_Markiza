...
<html lang="ru">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="views/css/style_header.css">
    ...
    <title>Маркиза</title>
    <link rel="icon" href="views/img/ico.png" type="image/x-icon">
  ...
  <body>
      <header>
                    <div id='logo'>
                            <a href='?item=main'>
                                 <img src='views/img/lable.jpg' title='Маркиза'>
                            </a>
                    </div>
                    <div id='top_row'>
                        <div id='about_menu'>